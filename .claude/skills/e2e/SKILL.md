...
Run an end-to-end validation of $ARGUMENTS (or the feature currently being developed) using the Playwright MCP browser tools.
...
2. **Navigate to the feature** — Open `http://localhost:3000` and go to the relevant page or flow for $ARGUMENTS.
