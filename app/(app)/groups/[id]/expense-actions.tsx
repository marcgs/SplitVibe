...
export default function ExpenseActions({
  ...
  return (
    <form onSubmit={handleSave} className="mt-3 space-y-3 rounded-md border border-zinc-200 p-3 dark:border-zinc-800">
      <div>
      ...
      <div className="flex items-center gap-2">
        ...
        <button
          ...
          disabled={loading}
          className="rounded-md border border-zinc-300 px-3 py-1.5 text-xs font-medium text-zinc-700 hover:bg-zinc-100 disabled:opacity-50 dark:border-zinc-700 dark:text-zinc-200 dark:hover:bg-zinc-900"
        >
          Cancel
        </button>
      </div>
